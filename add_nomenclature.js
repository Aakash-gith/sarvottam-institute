                ...
                <div class="card-content">
                    ...
                    <div class="try-box">
                        ...
                        <p>Try naming: CH₃CH₂CH₂COOH → ?<br>
                            Answer: <strong>Butanoic acid</strong> (4 carbons + -oic acid)</p>
                    </div>
               </div>
            </details>
`;

// Find the line containing "Naming carbon compounds" card closure
const searchStr = '</details>\r\n        </section>\r\n\r\n        <!-- 4.3 CHEMICAL PROPERTIES -->';
const insertIdx = content.indexOf(searchStr);

if (insertIdx !== -1) {
    content = content.slice(0, insertIdx) + '\n' + nomenclatureSection + '\r\n' + content.slice(insertIdx);
    fs.writeFileSync(filePath, content, 'utf8');
    console.log('✅ Nomenclature section added successfully!');
} else {
